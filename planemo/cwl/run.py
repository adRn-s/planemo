...
class CwlToolRunResponse(SuccessfulRunResponse):
    ...
    def __init__(
        self, runnable: Runnable, log: str, outputs: Optional[Dict[str, Union[Dict[str, Union[str, int]], int]]] = None
    ) -> None:
...
def run_cwltool(ctx: "PlanemoCliContext", runnable: Runnable, job_path: str, **kwds) -> Union[ErrorRunResponse, CwlToolRunResponse]:
